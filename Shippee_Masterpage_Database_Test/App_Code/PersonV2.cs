...
public class PersonV2 : Person
{
    ...
    public Int32 UpdateAPerson(int intPersonID)
    {
        ...
        string strSQL = "UPDATE Person SET FirstName = @PersonFirst, MiddleName = @PersonMiddle, LastName = @PersonLast, Street = @PersonStreet, City = @PersonCity, State = @PersonState, Zip = @PersonZip, Number = @PersonNum, EMail = @PersonMail WHERE PersonID = @Person_ID;";
